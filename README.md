...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/google-drive-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15193&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/google-drive-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `google-drive` can be installed with:

```
conda install google-drive
```

It is possible to list all of the versions of `google-drive` available on your platform with:
